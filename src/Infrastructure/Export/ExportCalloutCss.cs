...
internal static class ExportCalloutCss
{
    public const string Rules = """
        ...
        .details { border: 1px solid #d0d5dd; border-radius: 8px; padding: .5rem .85rem; margin: 1rem 0; }
        .details > summary { font-weight: 650; cursor: pointer; }
        .align-center { text-align: center; }
        .align-right { text-align: right; }
        .align-justify { text-align: justify; }
        figure, .figure { margin: 1rem 0; }
        figure img, .figure img { max-width: 100%; height: auto; }
        figure figcaption, .figure figcaption { font-size: .9rem; color: #667085; }
        .math { font-family: Cambria, 'Times New Roman', serif; }
        .link-card { border: 1px solid #d0d5dd; border-radius: 8px; padding: .65rem .85rem; margin: .75rem 0; }
        """;
}
